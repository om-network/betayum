...
description: "Connect Aikido to automate security evidence in Betayum"
---

## Overview

The Aikido Security integration syncs vulnerability and repository scanning data into Betayum, so compliance tasks can be automatically satisfied with continuous evidence.

## What Betayum Collects
...
1. Open the Aikido integration in Betayum
