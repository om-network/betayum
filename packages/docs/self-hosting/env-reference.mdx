...
| `NEXT_PUBLIC_APP_URL` | app | build/runtime | Public URL of the main app |
| `NEXT_PUBLIC_PORTAL_URL` | app | build/runtime | Public URL of the portal |
| `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY` | app, portal, framework-editor | build/runtime | Clerk publishable key |
| `CLERK_SECRET_KEY` | api, app, portal, framework-editor | runtime | Clerk secret key |
| `CLERK_JWT_ISSUER` | api, app, portal, framework-editor | runtime | Clerk JWT issuer URL |
| `CLERK_AUTHORIZED_PARTIES` | api, app, portal, framework-editor | runtime | Comma-separated allowed origins for Clerk sessions |
...
| `NEXT_PUBLIC_APP_URL` | app | build/runtime | required-minimal | Public main app URL |
| `NEXT_PUBLIC_PORTAL_URL` | app | build/runtime | required-minimal | Public portal URL |
| `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY` | app, portal, framework-editor | build/runtime | required-minimal | Clerk publishable key |
| `CLERK_SECRET_KEY` | api, app, portal, framework-editor | runtime | required-minimal | Clerk secret key |
| `CLERK_JWT_ISSUER` | api, app, portal, framework-editor | runtime | required-minimal | Clerk JWT issuer |
| `CLERK_AUTHORIZED_PARTIES` | api, app, portal, framework-editor | runtime | required-minimal | Allowed origins for Clerk |
...
CLERK_JWT_ISSUER="https://clerk.trycomp.ai"
CLERK_AUTHORIZED_PARTIES="https://portal.yourdomain.com"
RESEND_API_KEY="re_your_api_key"
```
</CodeGroup>
