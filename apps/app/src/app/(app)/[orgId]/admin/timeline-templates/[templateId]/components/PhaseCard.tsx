              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="flex flex-col gap-1">
                      <Label htmlFor={`phase-${phase.id}-desc`}>Description</Label>
                      <Input
                    ...
                    <div className="flex flex-col gap-1">
                      <Label htmlFor={`phase-${phase.id}-duration`}>Duration (weeks)</Label>
                      <Input
                      ...
                      >
                        <SelectTrigger size="sm">
                          <span className="text-sm">
                            {COMPLETION_OPTIONS.find((o) => o.value === completionType)?.label ??
                              completionType}
                          </span>
                        </SelectTrigger>
                  ...
                  <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will permanently remove this phase and all its configuration from the
                          template.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
