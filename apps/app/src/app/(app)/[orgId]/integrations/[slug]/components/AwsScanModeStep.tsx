...
import { Cloud, Security } from '@trycompai/design-system/icons';
 ...
 * exclusive:
 *
 *   1. Betayum Scanners (default) — our service adapters running
  ...
  return (
    <fieldset className="space-y-3" disabled={disabled}>
      ...
      <ScanModeCard
        ...
        icon={<Security className="h-4 w-4" />}
